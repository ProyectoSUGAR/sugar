...
if ($_SESSION['tipo_usuario'] !== 'direccion') {
    header('Location: ../../Login/HTML/ingreso.php');
    exit();
}
...
<header class="cabecera-institucional">
    ...
    <nav id="nav" class="main-nav">
            ...
            <a class="link-item" href="../../Direccion/HTML/registroDatos.php">Registro de Horarios</a>
        ...
        <a class="link-item" href="#contenedor-tablas-horarios">Horarios</a>
            <a class="link-item" href="../../Direccion/HTML/notificaciones.php">Anuncios</a>
                </div>
        </nav>
    <script>
