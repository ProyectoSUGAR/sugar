                    ...
                    <?php if ($asignaturas): ?>
                       ...
                       <?php foreach ($asignaturas as $a): ?>
                            <li class="pruebads">
                                ...
                                <a href="../../Direccion/HTML/asignacionAsig.php?editar=<?= $a['id_asignatura'] ?>" class="botoneditar"  style="text-decoration:none; padding:6px 8px; margin-left: 1rem;">Editar</a>
