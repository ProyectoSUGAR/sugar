...
<body class="bodyregidat">
    ...
    <main class="sugarads-main">
        ...
        <div class="sugarads-grid">
            <div class="sugarads-col-left">
                <!-- crear horario -->
                <form id="form-crear" class="formasig" method="post" action="../../Direccion/HTML/procesarHorario.php" style="border-top:2px solid #c7b299; padding-top:1.5rem; max-width:400px;">
                ...
                <form id="form-editar" class="sugarads-form" method="post" action="../../Direccion/PHP/registrarHorario.php" style="margin-top:2.5rem; border-top:2px solid #2d89ef; padding-top:1.5rem;">
                ...
                <form id="form-eliminar" class="sugarads-form" method="get" action="../../Direccion/HTML/registroDatos.php" style="margin-top:2.5rem; border-top:2px solid #e53935; padding-top:1.5rem;">
    ...
    <script src="../../Direccion/JS/bloquesHorarios.js"></script>
</body>
</html>
