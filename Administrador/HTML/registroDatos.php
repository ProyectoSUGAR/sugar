    ...
    <main class="sugarads-main">
        ...
        <div class="sugarads-grid">
            <div class="sugarads-col-left">
                ...
                <form id="form-editar" class="sugarads-form form-editar-inline" method="post" action="../PHP/registrarHorario.php">
                ...
                <form id="form-eliminar" class="sugarads-form form-eliminar-inline" method="get" action="registroDatos.php">
                    <h2 class="sugarads-section-title section-title-error">Eliminar Horario</h2>
                    <input type="hidden" name="eliminar" value="<?= intval($_GET['eliminar']) ?>">
                    <div class="sugarads-field">
                        <span>¿Estás seguro que deseas eliminar este horario?</span>
                    </div>
                    <div class="sugarads-field">
                        <button type="submit" class="btn-cancelar-error">Eliminar</button>
