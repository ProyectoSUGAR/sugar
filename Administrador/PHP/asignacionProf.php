...
function procesar_asignacion_profesor() {
    ...
    if ($_SERVER["REQUEST_METHOD"] !== "POST") {
        header("Location: ../../Administrador/HTML/asignacionProf?error=" . urlencode("Método no permitido."));
        exit;
    }
    ...
    if ($errores) {
        ...
        header("Location: ../../Administrador/HTML/asignacionProf?error=" . urlencode($mensajeError));
        exit;
    }
    ...
    header("Location: ../../Administrador/HTML/asignacionProf.php?resultado=" . urlencode("Asignación realizada correctamente."));
    exit;
}
