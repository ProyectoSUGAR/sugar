...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    echo 'Swal.fire({';
    echo 'icon: "success",';
    echo 'title: "Estado actualizado",';
    echo 'text: "El usuario ha sido actualizado correctamente."';
    echo '}).then(function(){ window.location.href = "../../HTML/gestionUsr.php"; });';
    echo '</script>';
    echo '<noscript><div style="color:green;text-align:center;margin-top:2em;">El usuario ha sido actualizado.<br><a href="../../HTML/gestionUsr.php">Volver</a></div></noscript>';
    exit;
    }
    ...
    echo 'text: "El usuario ha sido eliminado correctamente."';
    echo '}).then(function(){ window.location.href = "../../HTML/gestionUsr.php"; });';
    echo '</script>';
    echo '<noscript><div style="color:green;text-align:center;margin-top:2em;">El usuario ha sido eliminado.<br><a href="../../HTML/gestionUsr.php">Volver</a></div></noscript>';
    exit;
    }
}
