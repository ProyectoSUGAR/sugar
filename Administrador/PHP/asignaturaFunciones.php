...
function crearAsignatura($conn, $nombre) {
    ...
    if ($nombre !== '') {
        ...
        if ($ok) {
            echo "<script>alert('Asignatura registrada correctamente.'); window.location.href='../HTML/asignacionAsig.php';</script>";
            exit;
        } else {
...
function editarAsignatura($conn, $id, $nombre) {
    ...
    if ($nombre !== '') {
        ...
        mysqli_stmt_close($stmt);
        if ($ok) {
            echo "<script>alert('Asignatura editada correctamente.'); window.location.href='../HTML/asignacionAsig.php';</script>";
            exit;
        } else {
...
function eliminarAsignatura($conn, $id) {
    ...
    echo "<script>alert('No se puede eliminar la asignatura porque está relacionada con otros datos.'); window.location.href='../HTML/asignacionAsig.php';</script>";
        exit;
    }
}
